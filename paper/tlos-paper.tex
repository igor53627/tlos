...
\begin{enumerate}
  ...
  \item \textbf{LBLO layer (heuristic):} Defeats semantic attacks by hiding control functions via LBLO ciphertexts with on-chain inner products. Security is \emph{conjectured}, based on LBLO hardness (see Table~\ref{tab:lwe-security} and \S\ref{sec:lblo}).
